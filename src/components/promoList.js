      ...
      <div className="container relative z-10">
        <div className="m-auto w-3/4 md:w-3/4 lg:w-2/4">
          ...
          <div className="py-5 flex flex-col gap-y-2">
            ...
            <a className="m-auto w-1/4 text-center text-white p-2 bg-red-900 hover:bg-red-800"  href="https://www.telegraph.co.uk/customer/subscribe/?country=GB">Find Out More</a>
          </div>
        </div>
      </div>
    </section>
